...
import "package:quran_app/pages/quizz/qur'an/quran_questions.dart";

class QuranQuizPage extends StatefulWidget {
  const QuranQuizPage({Key? key}) : super(key: key);

  @override
  State<QuranQuizPage> createState() => _QuranQuizPage();
}

class _QuranQuizPage extends State<QuranQuizPage> {
  ...
  void _questionAnswered(bool answerScore) {
    setState(() {
      ...
      //when the quiz ends
      if (_questionIndex + 1 == quran.length) {
        endOfQuiz = true;
      }
    });
  }
  ...
  void _nextQuestion() {
    ...
    if (_questionIndex >= quran.length) {
      _resetQuiz();
    }
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Text(
                      quran[_questionIndex]['questionText'] as String,
              ...
              ...(quran[_questionIndex]['answers'] as List<Map<String, Object>>)
                  .map(
                (answer) => Answer(
